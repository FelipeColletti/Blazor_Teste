...
using Blazor_teste.Services;

namespace Blazor_teste
{
    public class Startup
    {
        ...
        {
            Syncfusion.Licensing.SyncfusionLicenseProvider.RegisterLicense("MjUzNzA0QDMxMzgyZTMxMmUzMEpHcy9ITnEyb1UwKzZFWVRRcVltUkpZdndnZTVrd2J4ZFJna3Y1NHNod289");
